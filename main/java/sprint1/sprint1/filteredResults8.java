...
public class filteredResults8 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.filtered_results_layout7);
        ...
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                final Intent intent = new Intent(filteredResults8.this, item.class);
...
//                            startActivity(intent);
    ...
    public void clickHomeWithinFilteredResults(View v) {
        if(v.getId() == R.id.homeButtonWithinFilteredResults) {
            Intent i = new Intent(filteredResults8.this, MainActivity.class);
            startActivity(i);
        }
    }
}